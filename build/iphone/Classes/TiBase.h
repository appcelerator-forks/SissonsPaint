...
// in simulator we redefine to format for sissionspaint Developer console
...
{\
	NSString * exceptionName = [@"org.sissionspaint." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sissionspaint";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsissionspaintNativeItemNone = -1, 
	UIsissionspaintNativeItemSpinner = -2,
	UIsissionspaintNativeItemProgressBar = -3,
	
	UIsissionspaintNativeItemSlider = -4,
	UIsissionspaintNativeItemSwitch = -5,
	UIsissionspaintNativeItemMultiButton = -6,
	UIsissionspaintNativeItemSegmented = -7,
	
	UIsissionspaintNativeItemTextView = -8,
	UIsissionspaintNativeItemTextField = -9,
	UIsissionspaintNativeItemSearchBar = -10,
	
	UIsissionspaintNativeItemPicker = -11,
	UIsissionspaintNativeItemDatePicker = -12,
	
	UIsissionspaintNativeItemInfoLight = -13,
	UIsissionspaintNativeItemInfoDark = -14,
	
	UIsissionspaintNativeItemDisclosure = -15,
	
	UIsissionspaintNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all sissionspaint instances of
