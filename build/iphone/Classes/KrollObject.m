...
//@interface sissionspaintObject : NSObject
//@end

@interface sissionspaintObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[sissionspaintObject class]])
		{
			for (NSString *key in [[(sissionspaintObject*)o modules] allKeys])
			{
