...
/**
 Base class for all sissionspaint views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the sissionspaint view hierarchy (such as wrapped iOS UIViews) was touched.
