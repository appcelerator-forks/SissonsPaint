...
@interface sissionspaintObject : KrollCoverageObject {
#else
@interface sissionspaintObject : KrollObject {
#endif
@private
...
extern NSString * sissionspaint$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	sissionspaintObject *_sissionspaint;
    KrollObject* console;
	BOOL shutdown;
