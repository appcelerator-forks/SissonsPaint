...
//Rare exceptions to indicate a bug in the _sissionspaint code (Eg, function that a subclass should have implemented)
...
/**
 The base class for sissionspaint proxies.
 */
