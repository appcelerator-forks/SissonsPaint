...
function Controller() {
    ...
    $.__views.diyPaint.add($.__views.__alloyId80);
    ...
    $.__views.__alloyId80.add($.__views.toggle);
    $.__views.__alloyId81 = Alloy.createController("toggle", {
        id: "__alloyId81",
        __parentSymbol: $.__views.toggle
    });
    $.__views.__alloyId81.setParent($.__views.toggle);
    ...
    $.__views.__alloyId80.add($.__views.canvas);
    ...
    $.__views.__alloyId80.add($.__views.colorSwatches);
    ...
    $.__views.colorSwatches.add($.__views.__alloyId83);
    ...
    $.__views.bottomColorBar.add($.__views.__alloyId84);
    ...
    $.__views.__alloyId80.add($.__views.sizeBar);
    ...
    $.__views.sizeBar.add($.__views.__alloyId87);
    ...
    $.__views.__alloyId80.add($.__views.toolbar);
    $.__views.__alloyId88 = Ti.UI.createView({
        layout: "horizontal",
        width: "100%",
        id: "__alloyId88"
    });
    $.__views.toolbar.add($.__views.__alloyId88);
    ...
    $.__views.__alloyId89.add($.__views.photoButton);
    ...
    $.__views.__alloyId90.add($.__views.tools);
    ...
    $.__views.__alloyId91.add($.__views.size);
    ...
    $.__views.__alloyId92.add($.__views.color);
    ...
    $.__views.__alloyId93.add($.__views.shareButton);
    ...
    $.__views.__alloyId98.add($.__views.checkBox);
    ...
    $.__views.__alloyId98.add($.__views.showWindow);
